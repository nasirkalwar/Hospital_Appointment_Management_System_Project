@include('home.header')
  <div class="page-banner overlay-dark bg-image" style="background-image: url(../assets/img/bg_image_1.jpg);">
    <div class="banner-section">
      <div class="container text-center wow fadeInUp">
        ...
        <h1 class="font-weight-normal" style="font-size:50px;">Contact</h1>
      </div> <!-- .container -->
    </div> <!-- .banner-section -->
  </div> <!-- .page-banner -->
  ...
  <div class="page-section">
    ...
    <h1 class="text-center wow fadeInUp">Get in Touch</h1>
      ...
      <form class="contact-form mt-5" action="{{url('/contactus_message')}}" method="POST">
        @csrf
      <div class="row mb-3">
        ...
        <button type="submit" class="btn btn-primary wow zoomIn"style=" border:2px solid lightgreen; color:green;">Send Message</button>
      </form>
    </div>
  </div>
